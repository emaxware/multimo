...
//procedure send_keyboard_input(wVk, wScan:WORD; dwFlags:DWORD);
//procedure send_mouse_input(dwFlags, dx, dy, dwData:DWORD);
...
//  if (dwFlags and KEYEVENTF_UNICODE) <> 0 then
//    inp.ki.wVk := 0
//  else
//    inp.ki.wVk := wVk; // 1..254 inclusive otherwise
//	inp.ki.wScan := wScan;
//	inp.ki.dwFlags := dwFlags and $F;
//	inp.ki.time := 0;
